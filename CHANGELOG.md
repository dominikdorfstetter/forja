...
Forja is a GDPR-first, multi-tenant headless CMS — a Rust (Axum) backend and a React (MUI Material 3) admin SPA — built privately over a long arc before its first public cut. The pre-1.0 entries below are a condensed history of how that foundation came together; precise dates start at the first public release.

## [Unreleased]

## [1.0.0] — 2026-06-05

The first public release of Forja: a multi-tenant, GDPR-first headless CMS with a Rust (Axum) backend, a React (MUI Material 3) admin SPA, and provider-agnostic integrations. Everything below is shipped and exercised end to end — backend, admin, client SDK, web-component library, and reference template.
...
_Condensed milestones from the private build-out. Exact dates were not preserved; phasing is given relative to the project's development arc._
...
- **Rocket → Axum cutover.** The backend was migrated off Rocket onto Axum, consolidating extraction, error handling, and routing.
...
[Unreleased]: https://github.com/dominikdorfstetter/forja/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/dominikdorfstetter/forja/releases/tag/v1.0.0
