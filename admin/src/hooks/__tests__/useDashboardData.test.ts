...
describe('useDashboardData', () => {
  ...
  it('computes status counts from blog and page data', async () => {
    ...
    vi.mocked(apiService.getBlogs).mockResolvedValue({
      data: [
        { id: 'b1', slug: 'b1', author: 'A', published_date: '', is_featured: false, status: 'Draft', created_at: '', updated_at: '' },
        { id: 'b2', slug: 'b2', author: 'A', published_date: '', is_featured: false, status: 'Published', created_at: '', updated_at: '' },
      ],
