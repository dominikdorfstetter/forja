...
const mockFollowers: Paginated<FederationFollower> = {
  data: [
    {
      id: 'f-1',
      followerActorUri: 'https://mastodon.social/users/alice',
      displayName: 'Alice',
      username: 'alice',
      avatarUrl: null,
      status: 'accepted',
      followedAt: '2025-06-01T00:00:00Z',
    },
    {
      id: 'f-2',
      followerActorUri: 'https://fosstodon.org/users/bob',
      displayName: 'Bob',
      username: 'bob',
      avatarUrl: null,
      status: 'accepted',
      followedAt: '2025-06-02T00:00:00Z',
    },
  ],
