      ...
      <Grid container spacing={1}>
        ...
        {page.published_at && (
          <Grid size={{ xs: 12, sm: 6 }}>
            ...
            <Typography variant="body2">{fmt(page.published_at, 'PPpp')}</Typography>
          </Grid>
        )}
        <Grid size={{ xs: 12, sm: 6 }}>
          <Typography variant="caption" color="text.secondary">{t('pageDetail.fields.created')}</Typography>
          <Typography variant="body2">{fmt(page.created_at, 'PPpp')}</Typography>
        </Grid>
        <Grid size={{ xs: 12, sm: 6 }}>
          <Typography variant="caption" color="text.secondary">{t('pageDetail.fields.updated')}</Typography>
          <Typography variant="body2">{fmt(page.updated_at, 'PPpp')}</Typography>
        </Grid>
      </Grid>
    </Box>
  );
