...
// Issue #623 Slice 4: shape comes from the backend OpenAPI spec via
// `@/types/api`; Zod stays for UX-only refinements (min/max lengths,
// required-form-fields) and runtime enum values that Zod needs.
