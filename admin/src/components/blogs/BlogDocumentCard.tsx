...
import { assignBlogDocument, downloadDocument, unassignBlogDocument } from '@/services/documents';
...
function getDocumentName(doc: BlogDocumentResponse): string {
...
export default function BlogDocumentCard({ blogId, documents }: BlogDocumentCardProps) {
  ...
  const unassignMutation = useMutation({
    mutationFn: (documentId: string) =>
      unassignBlogDocument(blogId, documentId),
    onSuccess: () => {
      invalidate();
