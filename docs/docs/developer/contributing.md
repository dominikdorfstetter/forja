...
Before pushing your branch, confirm all of the following:

- [ ] `./scripts/dev-test.sh` passes (full suite)
- [ ] `cd admin && npm run react-doctor:online` score is 100 (if frontend files changed)
- [ ] Documentation updated (Docusaurus + README if applicable)
- [ ] Changelog entry added (features and non-trivial fixes)
- [ ] All user-visible strings use i18n keys
- [ ] New interactive elements meet WCAG 2.1 AA
- [ ] Error paths have dedicated error codes and i18n messages
- [ ] Tests cover happy path, permissions, validation, and at least one edge case
