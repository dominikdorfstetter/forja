...
Navigate to your dashboard URL (e.g., `http://localhost:3000/dashboard` in development). You will see the Clerk login screen.
...
Click **Create** to save. Your site now appears in the site launcher and is automatically selected in the site selector at the top of the sidebar.

:::info
You can create multiple sites from a single Forja installation. Each site has its own content, languages, navigation, and settings. Use the site selector at the top of the sidebar to switch between them.
:::
...
|-----|-------------------|
| **Content** | Upload limits, email, maintenance mode, editorial workflow toggle |
| **Modules** | Enable/disable content modules (Blog, Pages, Portfolio, Legal, Documents, Forms, AI) |
| **SEO** | Title template, meta description fallback, OG image, robots.txt |
| **Favicon** | Upload a site icon to generate favicon variants |
| **API Keys** | Create API keys for frontend integration |
| **Members** | Invite users and manage permissions |
