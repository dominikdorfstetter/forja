...
1. **Sidebar** -- where you navigate between sections (Dashboard, Blogs, Pages, Assets, etc.), with the site selector in its header.
2. **Top bar** -- command palette trigger, notifications, help menu, and user (account) menu.
