...
To collect analytics data, add the `@forjacms/analytics` tracking library to your frontend. See the [Analytics Integration](../templates/analytics-integration) guide for setup instructions.
