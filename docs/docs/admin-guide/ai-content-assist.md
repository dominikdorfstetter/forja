...
| **Qwen (DashScope)** | `https://dashscope-intl.aliyuncs.com/compatible-mode` | qwen-plus | Yes |
...
|------|-------------|--------|
| **SEO Generation** | Generate meta titles and descriptions from blog content | No |
| **Excerpt Generation** | Create concise summaries of blog posts | No |
| **Translation** | Translate content to other locales | No |
| **Draft Outline** | Generate a structured outline for a new post | No |
| **Draft Post** | Generate a full draft from an outline or topic | No |
| **Auto-Tag** | Automatically suggest tags for images | Yes |
| **Alt Text** | Generate descriptive alt text for images | Yes |
