...
:::warning
**Bot protection token** — Forja stores the bot token but does NOT verify it server-side. Integrate your CAPTCHA provider's verification in your own webhook handler if you need verified-human-only signal.
:::
