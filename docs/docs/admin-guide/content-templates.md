...
Navigate to **Blogs** in the sidebar, then click the **Templates** tab (or go to `/blogs/templates`). The page shows all content templates for the currently selected site.
...
| Use templates when creating content | Editor |
