...
| `GET /sites/{site_id}/blogs/by-slug/{slug}` | Get a single blog post by slug |
| `GET /sites/{site_id}/pages` | List pages |
| `GET /sites/{site_id}/pages/by-route/{route}` | Get a single page by route |
| `GET /sites/{site_id}/cv` | Get CV entries and skills |
| `GET /sites/{site_id}/legal` | List legal documents |
| `GET /sites/{site_id}/legal/by-slug/{slug}` | Get a single legal document |
| `GET /menus/{menu_id}/tree` | Get navigation tree |
| `GET /sites/{site_id}/social` | Get social media links |
| `GET /sites/{site_id}/settings` | Get site settings (title, description, etc.) |
| `GET /sites/{site_id}/feed.rss` | RSS 2.0 feed for blog posts |
