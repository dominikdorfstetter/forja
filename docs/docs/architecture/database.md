...
| `site_role` | owner, admin, editor, author, reviewer, viewer |
...
| `section_type` | hero, features, cta, gallery, testimonials, pricing, faq, contact, custom, stats, team, timeline, logo_cloud, newsletter, video, divider, text |
...
| Table | Purpose |
|-------|---------|
| `sites` | Tenant root -- name, slug, base_url, description, default locale |
...
├── ...
├── 20240101000028_user_preferences.sql
├── ...
├── 20240101000047_trash_media_documents.sql
└── 20240101000048_new_section_types.sql
```
