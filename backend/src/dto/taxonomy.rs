...
impl CreateTagRequest {
    /// site_id is required when is_global is false.
    fn validate_site(&self) -> Result<(), String> {
...
impl ValidatedDto for CreateCategoryRequest {
    type Context = ();
...
/// Request to assign a tag to content
#[derive(Debug, Clone, Deserialize, Validate, ValidatedDto, utoipa::ToSchema)]
#[schema(description = "Assign tag to content")]
