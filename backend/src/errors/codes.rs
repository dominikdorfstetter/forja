...
pub const ALL: &[ErrorCodeDef] = &[
    ...
    ErrorCodeDef {
        ...
        domain: "entity",
        http_status: 404,
        description: "The requested entity instance does not exist (entity_type identifies which domain)",
    },
    ErrorCodeDef {
        code: ENTITY_SLUG_TAKEN,
        domain: "entity",
        http_status: 409,
        description: "An entity with this slug already exists (entity_type identifies which domain)",
    },
    ErrorCodeDef {
        code: ENTITY_LOCALIZATION_EXISTS,
        domain: "entity",
        http_status: 400,
        description: "A localization for this locale already exists on the entity (entity_type identifies which domain)",
    },
    ErrorCodeDef {
        code: ENTITY_LOCALIZATION_NOT_FOUND,
        domain: "entity",
        http_status: 404,
        description: "No localization found for the requested entity and locale (entity_type identifies which domain)",
    },
    // Site
    ErrorCodeDef {
    ...
    ErrorCodeDef {
        ...
        domain: "site",
        http_status: 410,
        description: "The 30-day grace window for restoring a soft-deleted site has lapsed",
    },
    ErrorCodeDef {
        code: SITE_EXPORT_FORBIDDEN,
        domain: "site",
        http_status: 403,
        description: "Only the site owner, a site admin, or a system admin may export a site archive",
    },
    ErrorCodeDef {
        code: SITE_EXPORT_JOB_NOT_FOUND,
        domain: "site",
        http_status: 404,
        description: "The site export job does not exist for this site, or its artifact has expired and been purged",
    },
    ErrorCodeDef {
        code: SITE_EXPORT_ALREADY_RUNNING,
        domain: "site",
        http_status: 409,
        description: "An export job for this site is already queued or running; wait for it to finish before requesting another",
    },
    ErrorCodeDef {
        code: SITE_EXPORT_FAILED,
        domain: "site",
        http_status: 500,
        description: "The export worker failed to build or store the site archive",
    },
    // Blog
    ErrorCodeDef {
    ...
    ErrorCodeDef {
        ...
        domain: "document",
        http_status: 401,
        description: "This document is password-protected and requires a password to access",
    },
    ErrorCodeDef {
        code: DOCUMENT_PASSWORD_INCORRECT,
        domain: "document",
        http_status: 403,
        description: "The provided password is incorrect",
    },
    ErrorCodeDef {
        code: DOCUMENT_ACCESS_RATE_LIMITED,
        domain: "document",
        http_status: 429,
        description: "Too many failed password attempts — try again later",
    },
    ErrorCodeDef {
        code: DOCUMENT_ENCRYPTION_FAILED,
        domain: "document",
        http_status: 500,
        description: "Failed to encrypt the document",
    },
    ErrorCodeDef {
        code: DOCUMENT_DECRYPTION_FAILED,
        domain: "document",
        http_status: 500,
        description: "Failed to decrypt the document — wrong password or corrupted data",
    },
    ErrorCodeDef {
        code: DOCUMENT_NOT_UPLOADABLE,
        domain: "document",
        http_status: 400,
        description: "Only uploaded documents (not URL-based) can be password-protected",
    },
    ErrorCodeDef {
        code: DOCUMENT_EXPIRED,
        domain: "document",
        http_status: 410,
        description: "The private document's access window has expired and it is no longer downloadable",
    },
    ErrorCodeDef {
        code: DOCUMENT_LOCKED,
        domain: "document",
        http_status: 423,
        description: "The document is locked after 3 failed password attempts and must be unlocked by an admin",
    },
    ErrorCodeDef {
        code: DOCUMENT_NOT_LOCKED,
        domain: "document",
        http_status: 409,
        description: "Unlock requested on a document that is not currently locked",
    },
    ErrorCodeDef {
        code: DOCUMENT_INVALID_TTL,
        domain: "document",
        http_status: 400,
        description: "expires_at must be in the future and at most one year ahead",
    },
    // Media
    ErrorCodeDef {
    ...
    ErrorCodeDef {
        code: MEDIA_TOO_MANY_TAGS,
        domain: "media",
        http_status: 400,
        description: "Too many tags on media file",
    },
    // Storage Quota
    ErrorCodeDef {
        ...
        domain: "storage",
        http_status: 413,
        description: "Upload would exceed the per-site storage quota",
    },
    // Trash
    ErrorCodeDef {
        code: TRASH_ALREADY_RESTORED,
        domain: "trash",
        http_status: 400,
        description: "The item is not in the trash (already restored or never deleted)",
    },
    ErrorCodeDef {
        code: TRASH_NOT_DELETED,
        domain: "trash",
        http_status: 400,
        description: "The item is not soft-deleted and cannot be permanently removed from trash",
    },
    // Auth
    ErrorCodeDef {
    ...
    ErrorCodeDef {
        code: AUTH_TOKEN_AUDIENCE,
        domain: "auth",
        http_status: 401,
        description: "The JWT `aud` claim does not match the configured expected audience",
    },
    ErrorCodeDef {
        code: AUTH_TOKEN_ISSUER,
        domain: "auth",
        http_status: 401,
        description: "The JWT `iss` claim does not match the configured expected issuer",
    },
    ErrorCodeDef {
    ...
    ErrorCodeDef {
        ...
        domain: "auth",
        http_status: 429,
        description: "Too many failed authentication attempts — wait before retrying",
    },
    // API Key
    ErrorCodeDef {
    ...
    ErrorCodeDef {
        code: SITE_OWNER_CANNOT_LEAVE,
        domain: "site_membership",
        http_status: 403,
        description: "Site owners must transfer ownership before leaving",
    },
    // Legal
    ErrorCodeDef {
        code: LEGAL_PUBLISH_MISSING_TITLE,
        domain: "legal",
        http_status: 400,
        description: "Legal document must have a title before publishing",
    },
    ErrorCodeDef {
        code: LEGAL_PUBLISH_MISSING_BODY,
        domain: "legal",
        http_status: 400,
        description: "Legal document must have content before publishing",
    },
    ErrorCodeDef {
        code: LEGAL_VERSION_SOURCE_DELETED,
        domain: "legal",
        http_status: 404,
    ...
    // CV
    ErrorCodeDef {
        code: CV_BULK_STATUS_REQUIRED,
        domain: "cv",
        http_status: 400,
        description: "The status field is required for UpdateStatus bulk action on CV entries",
    },
    // Project
    ErrorCodeDef {
        code: PROJECT_BULK_STATUS_REQUIRED,
        domain: "project",
        http_status: 400,
        description: "The status field is required for UpdateStatus bulk action on projects",
    },
    // Redirect
    ErrorCodeDef {
    ...
    ErrorCodeDef {
        code: WEBHOOK_URL_SSRF,
        domain: "webhook",
        http_status: 400,
        description: "The webhook URL targets a private or internal network address",
    },
    ErrorCodeDef {
        code: WEBHOOK_INVALID_DEBOUNCE,
        domain: "webhook",
        http_status: 422,
        description: "Debounce value must be between 0 and 300 seconds",
    },
    ErrorCodeDef {
        code: WEBHOOK_INVALID_STATS_WINDOW,
        domain: "webhook",
        http_status: 400,
        description: "Stats time window must be one of: 1h, 24h, 7d, 30d",
    },
    // Notification
    ErrorCodeDef {
    ...
    ErrorCodeDef {
        ...
        domain: "ai",
        http_status: 400,
        description: "The AI base URL or vision image URL targets a private or internal network address",
    },
    ErrorCodeDef {
        code: AI_VISION_MISSING_IMAGE,
        domain: "ai",
        http_status: 400,
        description: "image_url is required for vision actions (auto_tag, alt_text)",
    },
    ErrorCodeDef {
        code: AI_SECTION_CONTEXT_INSUFFICIENT,
        domain: "ai",
        http_status: 400,
        description: "section_context with section_type is required for section_content action",
    },
    ErrorCodeDef {
        code: AI_SECTION_TYPE_UNKNOWN,
        domain: "ai",
        http_status: 400,
        description: "Unknown page-section type — must be one of the SectionType enum values",
    },
    ErrorCodeDef {
        code: AI_CONTEXT_INSUFFICIENT,
        domain: "ai",
        http_status: 400,
        description: "Content is too short for the AI to produce a useful suggestion (e.g. blog body shorter than the minimum word count for tag generation)",
    },
    // Clerk
    ErrorCodeDef {
    ...
    ErrorCodeDef {
        ...
        domain: "workflow",
        http_status: 403,
        description: "Editorial workflow requires content to be submitted for review before publishing",
    },
    ErrorCodeDef {
    ...
    // Forms
    ErrorCodeDef {
        code: FORM_DUPLICATE_FIELD_LABELS,
        domain: "forms",
        http_status: 400,
        description: "Form definition contains duplicate field labels",
    },
    ErrorCodeDef {
        code: FORM_TEMPLATE_NAME_EXISTS,
        domain: "forms",
        http_status: 409,
        description: "Another form template on this site already uses this name",
    },
    ErrorCodeDef {
        code: FORM_BOT_PROTECTION_MISSING,
        domain: "forms",
        http_status: 400,
        description: "Form requires a bot_protection_token but none was provided",
    },
    ErrorCodeDef {
        code: FORM_BOT_PROTECTION_INVALID,
        domain: "forms",
        http_status: 400,
        description: "Captcha provider reported the supplied token did not pass verification",
    },
    ErrorCodeDef {
        code: FORM_BOT_PROTECTION_NOT_CONFIGURED,
        domain: "forms",
        http_status: 503,
        description: "Form is Mandatory-protected but the site has no captcha verifier configured",
    },
    ErrorCodeDef {
        code: FORM_BOT_PROTECTION_PROVIDER_ERROR,
        domain: "forms",
        http_status: 503,
        description: "Captcha provider was unreachable or returned an unexpected response",
    },
    ErrorCodeDef {
        code: FORM_VALIDATION_FAILED,
        domain: "forms",
        http_status: 400,
        description: "One or more submission fields failed validation",
    },
    ErrorCodeDef {
        code: FORM_CONSENT_REQUIRED,
        domain: "forms",
        http_status: 400,
        description: "Form requires consent but consent_given was false",
    },
    ErrorCodeDef {
        code: FORM_SUBMISSION_DELETED,
        domain: "forms",
        http_status: 410,
        description: "Submission has been deleted (idempotent self-service signal)",
    },
    ErrorCodeDef {
        code: FORM_INVALID_REFERENCE_CODE,
        domain: "forms",
        http_status: 404,
        description: "Reference code does not match any submission",
    },
    ErrorCodeDef {
        code: FORM_INVALID_STATUS_TRANSITION,
        domain: "forms",
        http_status: 400,
        description: "Requested submission status transition is not allowed",
    },
    // Custom types / Collections (#789 epic)
    ErrorCodeDef {
        code: ERR_CUSTOM_TYPE_FORBIDDEN,
        domain: "custom_types",
        http_status: 403,
        description: "You do not have permission to manage custom types on this site",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_TYPE_NOT_FOUND,
        domain: "custom_types",
        http_status: 404,
        description: "No custom type with that key exists on this site",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_TYPE_RESERVED_NAME,
        domain: "custom_types",
        http_status: 422,
        description: "The type key collides with a built-in entity type",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_TYPE_KEY_TAKEN,
        domain: "custom_types",
        http_status: 409,
        description: "Another custom type on this site already uses this key",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_TYPE_IN_USE,
        domain: "custom_types",
        http_status: 409,
        description: "The custom type still has entries; delete them first or force",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_TYPE_LIMIT,
        domain: "custom_types",
        http_status: 422,
        description: "The site has reached the maximum number of custom types",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_FIELD_LIMIT,
        domain: "custom_types",
        http_status: 422,
        description: "The type has reached the maximum number of fields",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_FIELD_DUPLICATE_KEY,
        domain: "custom_types",
        http_status: 422,
        description: "Two fields in the type share the same key",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_FIELD_INVALID_TYPE,
        domain: "custom_types",
        http_status: 422,
        description: "Unknown field type",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_FIELD_INVALID_PATTERN,
        domain: "custom_types",
        http_status: 422,
        description: "A field pattern is not a valid regular expression",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_FIELD_ENUM_OPTIONS_MISSING,
        domain: "custom_types",
        http_status: 422,
        description: "An enum field must declare at least one option",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_FIELD_TITLE_REQUIRED,
        domain: "custom_types",
        http_status: 422,
        description: "A type must designate exactly one title field",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_FIELD_LEGAL_BASIS_MISSING,
        domain: "custom_types",
        http_status: 422,
        description: "A PII field must declare a legal basis",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_FIELD_PII_PUBLIC,
        domain: "custom_types",
        http_status: 422,
        description: "A publicly-readable type may not expose an unmarked PII field",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_ENTRY_VALIDATION,
        domain: "custom_types",
        http_status: 422,
        description: "Entry values failed schema validation",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_ENTRY_REQUIRED_FIELD,
        domain: "custom_types",
        http_status: 422,
        description: "A required entry field is missing",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_ENTRY_TOO_LARGE,
        domain: "custom_types",
        http_status: 413,
        description: "The entry payload exceeds the per-site size limit",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_FIELD_UNIQUE_CONFLICT,
        domain: "custom_types",
        http_status: 409,
        description: "Another entry already uses this unique field value",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_FIELD_REQUIRED_CONFLICT,
        domain: "custom_types",
        http_status: 422,
        description: "Cannot make a field required: existing entries lack a value",
    },
    ErrorCodeDef {
        code: ERR_CUSTOM_FIELD_RETYPE_INCOMPATIBLE,
        domain: "custom_types",
        http_status: 422,
    ...
    ErrorCodeDef {
        ...
        domain: "system",
        http_status: 413,
        description: "The request payload exceeds the allowed limit (generic)",
    },
];
