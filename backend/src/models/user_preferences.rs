...
// Demo mode key
pub const KEY_DEMO_SITE_OPTED_IN: &str = "demo_site_opted_in";
...
mod tests {
    ...
    fn test_defaults_merge_with_overlay() {
        ...
        assert_eq!(defaults[KEY_LANGUAGE], serde_json::json!("de"));
        assert_eq!(defaults[KEY_THEME_ID], serde_json::json!("mocha"));
    }
    ...
    fn test_partial_overlay_preserves_other_defaults() {
        ...
        assert_eq!(defaults[KEY_LANGUAGE], serde_json::json!("en"));
        assert_eq!(defaults[KEY_THEME_ID], serde_json::json!("latte"));
    }
}
